...
function App() {
  return (
    <div className='grid md:grid-cols-1 lg:grid-cols-4 grid-flow-row md:grid-rows-1 lg:grid-rows-6 gap-3'>
      <div className='bg-yellow-100 rounded-lg flex flex-col justify-center md:row-span-1 lg:row-span-3 p-4'>
        <p className='text-4xl lg:text-5xl xl:text-5xl 2xl:text-6xl font-semibold -tracking-widest leading-2'>Create and schedule content  <span className='text-purple-500'>quiker</span></p>
        <img className='w-3/5 lg:w-3/5 xl:w-4/5 mt-5' src="public/assets/images/illustration-create-post.webp" alt="create-post" />
      </div>
      ...
      <div className='bg-white rounded-lg row-span-2 lg:row-span-2 flex flex-col justify-center items-center p-4'>
        ...
        <p className='text-4xl lg:text-3xl font-semibold leading-1 -tracking-wide'>Manage multiple accounts and platforms</p>
      </div>
      <div className='bg-yellow-500 rounded-lg  lg:row-span-2 flex flex-col lg:justify-center lg:items-center p-5 pb-0 overflow-hidden '>
        <p className='text-5xl leading-2 -tracking-widest mb-2 ' style={{ lineHeight: "0.8" }}>Maintain a consistent posting schedule</p>
        <img className='w-60 -mb-6 lg:-mb-20 xl:-mb-20 mt-5' src="public/assets/images/illustration-consistent-schedule.webp" alt="illustration-consistent-schedule" />
      </div>
      
     <div className='bg-yellow-500 rounded-lg row-span-3 flex flex-col justify-center items-center  p-4 order-last lg:order-none'>
        <p className='text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl mb-5 '>Write your content using AI</p>
  ...
  <p className='text-white text-5xl lg:text-3xl xl:text-3xl 2xl:text-5xl  font-semibold text-center md:text-left'>
